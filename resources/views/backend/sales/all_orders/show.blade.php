        ...
        <div class="row gutters-5">
            ...
            <div class="col-md-3 ml-auto">
                ...
                <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_payment_status">
                    ...
                    <option value="partial" @if ($payment_status == 'partial') selected @endif>{{translate('Partial')}}</option>
        ...
        <div class="row gutters-5">
            <div class="col text-center text-md-left">
                <address>
                    ...
                    {{ json_decode($order->shipping_address)->address }}, {{ isset(json_decode($order->shipping_address)->ccity) ? json_decode($order->shipping_address)->ccity : '' }}, {{ json_decode($order->shipping_address)->postal_code }}<br>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                @else
                                <span class="badge badge-inline badge-info">Cancel</span>
                                @endif
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                {{ single_price($order->grand_total - $order->paid) }}
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="clearfix float-right">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong class="text-muted">{{translate('Shipping')}} ({{ json_decode($order->shipping_address)->city }} ) :</strong>
                        </td>
                        <td>
