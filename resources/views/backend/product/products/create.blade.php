...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('medicine.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <select id='tags' name="generic" class="w-100 form-control">
                                    @foreach($generics as $generic)
                                        <option value="{{ $generic[0]->generic }}">{{ $generic[0]->generic }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="weight" placeholder="{{ translate('Unit (e.g. ml, mg w/w, mg/vial)') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id='c_name' name="c_name" class="w-100 form-control">
                                    @foreach($cNames as $name)
                                        <option value="{{ $name[0]->c_name }}">{{ $name[0]->c_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Single price') }}" name="single_price" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate("(e.g 14's pack: ৳ 16,100.00)") }}" name="pack_Price" class="form-control" required>
                            </div>
                        </div>
{{--
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="indications"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Pharmacology')}}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" name="pharmacology"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Dosage Administration')}}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" name="dosage_administration"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="pregnancy_and_Lactation"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Therapeutic')}}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" name="therapeutic"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Storage Conditions')}}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" name="storage_conditions"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
