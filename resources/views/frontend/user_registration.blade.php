                        ...
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated)
                                            <div class="form-group phone-form-group mb-1">
                                                <input type="tel" id="phone-code" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="01XXXXXXXXX" name="phone" autocomplete="off">
                                            </div>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mb-0 fs-14">{{ translate('Already have an account?')}}</p>
                                    <a class="fs-16" href="{{ route('user.login') }}">{{ translate('Log In')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
