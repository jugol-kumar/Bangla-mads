...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --soft-primary: rgba(192, 172, 173, 0.15);
        }
...
<div style="background-color: inherit;" id="preeloader" class="d-flex align-items-center justify-content-center"></div>
    ...
    <div class="aiz-main-wrapper d-flex flex-column bg-white">
        ...
        <div class="d-flex">
            <div class="left-sidebar d-none d-lg-block">
                @include('frontend.inc.left_sidebar')
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-md">
            <div class="modal-content position-relative border-0 rounded-0">
                <div class="pb-5 pt-4 px-5">
                    <img class="mw-100 img-fit" src="{{ static_asset('assets/img/dua.jpg') }}" alt="">
                </div>
    ...
    <script>
        ...
        $('#togglebutton').on('click', function(e) {
            // alert("click here");
            $('.left-sidebar').toggleClass("d-none"); //you can list several class names
            e.preventDefault();
        });
    </script>
    ...
    <script>
        ...
        $(document).on('click', '.mini-cart', function () {
            $('.mini-cart').parent().toggleClass('expanded');
        });
        $(document).on('click', '.close-sidecart', function () {
            $('.mini-cart').parent().removeClass('expanded');
        });
