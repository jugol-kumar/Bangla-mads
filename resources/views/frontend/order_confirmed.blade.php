            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="card shadow-sm border-0 rounded">
                        <div class="card-body">
                            <div class="py-4 mb-4">
                                <h1 class="h3 mb-3 fw-600 text-center">{{ translate('Thank You for Your Order!')}}</h1>
                                    ...
                                    <div class="col-xl-5 col-md-6 ml-auto mr-0">
                                        <table class="table ">
                                            <tbody>
                                                ...
                                                @if ($order->payment_type == 'partial' && $order->grand_total > $order->transactions->sum('amount'))
                                                <tr>
                                                    <th><span class="fw-600">{{ translate('Paid')}}</span></th>
                                                    <td class="text-right">
                                                        <strong><span>{{ single_price($order->transactions->sum('amount')) }}</span></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><span class="fw-600">{{ translate('Due')}}</span></th>
                                                    <td class="text-right">
                                                        <strong><span>{{ single_price($order->grand_total - $order->transactions->sum('amount')) }}</span></strong>
                                                    </td>
                                                </tr>
                                                @endif
                                            </tbody>
