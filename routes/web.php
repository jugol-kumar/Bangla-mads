...
Route::get('/customers/login', 'HomeController@login')->name('user.login');
Route::get('/customers/registration', 'HomeController@registration')->name('user.registration');
//Route::post('/customers/login', 'HomeController@user_login')->name('user.login.submit');
Route::post('/customers/login/cart', 'HomeController@cart_login')->name('cart.login.submit');
...
Route::post('/home/section/best_brands', 'HomeController@load_best_brands_section')->name('home.section.best_brands');
//category dropdown menu ajax call
Route::post('/category/nav-element-list', 'HomeController@get_category_items')->name('category.elements');

//Invest Page
Route::get('/invest', 'HomeController@invest_page')->name('invest');
Route::post('/invest', 'HomeController@invest_store')->name('invest_store');
...
Route::get('/product/{slug}/{id}', 'HomeController@product')->name('product');
Route::get('/category/{category_slug}', 'HomeController@listingByCategory')->name('products.category');
Route::get('/category/details/{category_slug}', 'HomeController@categoryDetails')->name("category.details");
Route::get('/c-name/details/{c_name}', 'HomeController@cNameDetails')->name('cname.details');
Route::get('/generic/details/{generic}', 'HomeController@genericDetails')->name('generic.details');
...
Route::post('/cart/nav-sidebar-cart-items', 'CartController@updateSidebarNavCart')->name('cart.sidebar_nav_cart');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::post('/purchase_history/make_partial_payment', 'PartialPaymentController@show_payment_modal')->name('checkout.make_partial_payment');
    Route::post('/purchase_history/submit_partial_payment', 'PartialPaymentController@submit_partial_payment')->name('purchase_history.make_partial_payment');
...
Route::post('/shurjopay/callback', 'ShurjoPayController@response')->name('shurjopay.callback');
...
Route::get('/load-more/product-list','HomeController@categoryProductLoader')->name('cagoryproduct.loadmore');
